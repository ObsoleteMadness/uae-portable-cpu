...
extern int do_specialties(int);
extern void BusError68000(uaecptr addr, int ws, int fc);
...
STATIC_INLINE uae_u32 get_iword(int o) { return (*x_get_iword)(o); }
STATIC_INLINE uae_u32 get_ilong(int o) { return (*x_get_ilong)(o); }
STATIC_INLINE uae_u32 get_ibyte(int o) { return (*x_get_ibyte)(o); }
STATIC_INLINE uae_u32 next_iword(void) { return (*x_next_iword)(); }
STATIC_INLINE uae_u32 next_ilong(void) { return (*x_next_ilong)(); }
STATIC_INLINE int adjust_cycles(int cycles) { return cycles; }
...
{
	if (regs.pc_p != NULL && regs.pc_oldp != NULL)
